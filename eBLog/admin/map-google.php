...
<header class="topbar" data-navbarbg="skin5">
            <nav class="navbar top-navbar navbar-expand-md navbar-dark">
                <div class="navbar-header" data-logobg="skin6">
                    ...
                    <a class="navbar-brand" href="dashboard.html">
                        ...
                        <b class="logo-icon">
                            <!-- Dark Logo icon -->
                            <img src="asserts/plugins/images/logo-icon.png" alt="homepage" />
                        </b>
                        <!--End Logo icon -->
                        <!-- Logo text -->
                        <span class="logo-text">
                            <!-- dark Logo text -->
                            <img src="asserts/plugins/images/logo-text.png" alt="homepage" />
                        </span>
                    </a>
                    <!-- ============================================================== -->
                    <!-- End Logo -->
                    ...
                    <ul class="navbar-nav ms-auto d-flex align-items-center">
                        ...
                        <li>
                            <a class="profile-pic" href="#">
                                <img src="asserts/plugins/images/users/varun.jpg" alt="user-img" width="36"
    ...
    <!-- google maps api -->
    <script src="asserts/http://maps.google.com/maps/api/js?sensor=true"></script>
    <script src="asserts/plugins/bower_components/gmaps/gmaps.min.js"></script>
    <script src="asserts/plugins/bower_components/gmaps/jquery.gmaps.js"></script>
    <!--Custom JavaScript -->
